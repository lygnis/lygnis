...
namespace DX
{
	...
	public:
		...
		UINT				m_iIndexSize;
	public:
		void PreRender(ID3D11DeviceContext* _pContext, UINT iVertexSize = 0);
		void PostRender(ID3D11DeviceContext* _pContext, UINT iCount = 0);
		bool Render(ID3D11DeviceContext* _pContext, UINT iVertexSize = 0, UINT iCount = 0);
	};
}
